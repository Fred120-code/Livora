  ...
  return (
    <div className="px-[8%] lg:px-[16%] py-20 pt-30" id="expertise">
      <div className="text-center">
        ...
        <h2
          className="text-5xl lg:text-8xl text-white rethink font-bold
        mt-5"
        >
          ...
          >
            ...
            <div className=" overflow-hidden rounded mb-5">
              <Image
                src={item.img}
                alt={`${item.title}Img`}
                className=" mx-auto rounded transition-transform duration-500
                     ease-out group-hover:scale-110"
              />
            </div>

            <button
              className="rethink font-medium text-lg cursor-pointer flex justify-center
             items-center w-full gap-2 border py-3 border-gray-200/20 hover:bg-gray-200/10
